...
var debug = (0, _debug2.default)('feathers-authentication-oauth1:verify');

var OAuth1Vierifier = function () {
  function OAuth1Vierifier(app) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    _classCallCheck(this, OAuth1Vierifier);
  ...
  return OAuth1Vierifier;
}();

exports.default = OAuth1Vierifier;
